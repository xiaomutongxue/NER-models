...
from ner.models.albert_for_ner import AlbertSoftmaxForNer
from ner.models.bert_for_ner import BertSoftmaxForNer
...
logger = init_logger(log_file='bert_softmax_{}.log'.format(datetime.today().strftime('%Y%m%d')))
